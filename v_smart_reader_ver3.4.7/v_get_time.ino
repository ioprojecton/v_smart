...
#define DS1307_ADDRESS 0x68
  ...
  if (((m == 3 && md >= 14 - (1 + ((y + 2000) * 5 >> 2)) % 7) && !_dst) || ((m > 3 && m < 11) && !_dst) || ((m == 11 && md < 7 - (1 + (5 * (y + 2000) >> 2)) % 7) && !_dst)) ++hr;
  else EEPROM.put(EEPROM_DST, true);

  if (((m == 11 && md >= 7 - (1 + (5 * (y + 2000) >> 2)) % 7) && _dst) || ((m > 11 && m < 3) && _dst) || ((m == 3 && md < 14 - (1 + ((y + 2000) * 5 >> 2)) % 7) && !_dst)) --hr;
