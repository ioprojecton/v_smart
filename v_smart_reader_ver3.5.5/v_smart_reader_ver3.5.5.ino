...
#define DEBUG 1
#define CALLED_FUNCTION() Serial.print("INSIDE ");Serial.println(__func__)
#define EXIT_FUNCTION() Serial.print("OUT FROM ");Serial.println(__func__)
#define _sizeof(x) (unsigned int)(sizeof(x)/sizeof(x[0]))
#define TODEC(x) ((((x)>>4)*10)+((x)%16))
